...
//***************BOOKING***************
    ...
    router.get('/api/patient-booking-specialization', PatientController.handleBooking_2); // render frontend select specialization
    router.post('/api/booking-state-specialization', PatientController.postBooking_specialization); // save specializationId and redirect to /api/patient-booking-doctor
